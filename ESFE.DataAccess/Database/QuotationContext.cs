...
//        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-2RKPK4G;Initial Catalog=myquotations;Integrated Security=True;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27D852FB92");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5AF93BE05");
        ...
        {
            entity.HasKey(e => e.QuotationId).HasName("PK__quotatio__7841D7DBB36098C2");
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Quotations)
                ...
                .HasConstraintName("FK__quotation__user___5441852A");
        });

        modelBuilder.Entity<QuotationDetail>(entity =>
        {
            entity.HasKey(e => e.QuotationDetailId).HasName("PK__quotatio__131ABC604F12A33E");
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.QuotationDetails)
                ...
                .HasConstraintName("FK__quotation__produ__5812160E");

            entity.HasOne(d => d.Quotation).WithMany(p => p.QuotationDetails)
                .HasForeignKey(d => d.QuotationId)
                .HasConstraintName("FK__quotation__quota__571DF1D5");
        });

        modelBuilder.Entity<Role>(entity =>
        {
            entity.HasKey(e => e.RolId).HasName("PK__roles__CF32E4434B519245");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__users__B9BE370F7FECCCAB");
            ...
            entity.HasOne(d => d.Rol).WithMany(p => p.Users)
                ...
                .HasConstraintName("FK__users__rol_id__4CA06362");
        });
